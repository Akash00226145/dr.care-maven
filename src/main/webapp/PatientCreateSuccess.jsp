...
<title>Patient Create Success</title>
...
<link href="asset/includes/css/bootstrap-glyphicons.css"
	rel="stylesheet">
...
<body>
	<div class="container" id="main">
		...
		<div class="navbar navbar-fixed-top">
			<div class="container" style="padding: 0;">
				...
				<a class="navbar-brand" href="/"><img
					src="asset/images/logo.png" alt="Your Logo"></a>
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							...
							<ul class="dropdown-menu">
								...
								<li><a href="#">GP Login</a></li>
								<li><a href="#">Pharmacist Login</a></li>
								<li><a href="OtherStaffLogin.jsp">Other Staff Login</a></li>
		...
		<div class="container">
			...
			<h2 class="form-signin-heading" style="font-family: cursive;">Create Patient Success</h2>
		</div>
		<div class="row" id="moreInfo"></div>


		<div class="row" id="moreCources"></div>
	...
	<div class="container">
		<div class="row">
			<img src="asset/images/HTML5White.png" width="63" height="64"
