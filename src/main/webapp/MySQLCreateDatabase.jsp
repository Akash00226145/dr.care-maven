	...
	<body>
		...
		<div class="container" id="main">
			...
			<div class="container" style="background-color: white;">
			 <form class="form-signin"  method="post" action="MySQLDeleteDatabase">
			        <h2 class="form-signin-heading">Dealete / Create Database</h2>
			        </p><p><b>
			        
			        <button class="btn btn-lg btn-primary btn-block" type="submit">Delete</button>
			       	</p><p><b>
					<p><i>This Action Will wipe all data from Dr. Care Database, and replace by empty tables Do it carefully</i></p>
